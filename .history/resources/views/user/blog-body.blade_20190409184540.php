            ...
            <div class="col-md-12">
             <div class="item_body ">
                ...
                <div class="item_body_content">
                  ...
                  <input class="form-control" placeholder="Post title" id="exampleTextarea">
                </div>
                 <div class="form-group">
                  <textarea class="form-control" placeholder="Write your post here...." id="exampleTextarea" rows="3"></textarea>
                </div>
                </div>
