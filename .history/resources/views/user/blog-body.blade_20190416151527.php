...
$(document).ready(function() {
    $("#{{$p->id}}").click(function() {
        $('#comment_{{$p->id}}').after("<div class='avatar'><img src='/images/user_profile/{{\Auth::user()->profile_pic}}'  width='30' class='avatar-photo'>	<form method='POST'action='/comment/{{user()->id}}/{{$p->id}}'><input type='text' name='comment'><br><button type='submit'>Submit</button></form><br>");
    });
})
</script> 
  			  @endforeach
