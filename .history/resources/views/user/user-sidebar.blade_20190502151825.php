        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center mb-1">
                <form action="/user_update/{{\Auth::id()}}" method="POST">
                  ...
                  <div class="md-form ml-0 mr-0">
                    <input type="password" name="phone" id="phone" class="form-control form-control-sm validate ml-0">
                  ...
                  <div class="md-form ml-0 mr-0">
                    ...
                    <label data-error="wrong" data-success="right" for="blood" class="ml-0">Add Blood</label>
                  </div>
                    <div class="row">
                        <div class="col-sm-12">
